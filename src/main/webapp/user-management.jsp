   ...
   <c:import url="adminHeader.jsp"></c:import>
    ...
    <div class="d-flex mt-2 mb-2" style="margin-top: 80px !important;">
      ...
      <div class="w-75 rounded me-2 bg-dark p-4"  style="margin-left: 390px !important;">
        <div class="mb-3">
          <h3 class="text-white mb-0">Users List</h3>
        </div>
          ...
          <tbody>
            <c:forEach items="${ users }" var="u">
            	<tr>
	              ...
	              <td class="text-white">${ u.role }</td>
	              <td>
	              	<c:url value="/admin/user/edit" var="userEdit">
	              		<c:param name="userId" value="${ u.id }"></c:param>
	              	</c:url>
	                <a href="${ userEdit }" class="btn btn-warning btn-sm">Edit</a>
	                <c:url value="/admin/user/delete" var="userDelete">
	              		<c:param name="userId" value="${ u.id }"></c:param>
	              	</c:url>
	                <a href="${ userDelete }" class="btn btn-danger btn-sm">Delete</a>
	              </td>
	            </tr>
            </c:forEach>
          </tbody>
